...
export default async function DashboardPage() {
  ...
  // Calculate stats
  const thisWeekHours = contractor?.timeEntries
    .filter((te) => {
  ...
  const pendingPayments = contractor?.payments
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">
            Welcome back{contractor ? `, ${contractor.firstName}` : ""}!
          </h1>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-8 flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-yellow-700">
                You have {contractor.documents.length} document(s) pending signature
              </div>
            </div>
            <Link
              href="/documents"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl border">
            ...
            <div className="divide-y">
              {!contractor?.timeEntries || contractor.timeEntries.length === 0 ? (
          ...
          <div className="bg-white rounded-xl border">
            ...
            <div className="divide-y">
              {!contractor?.projectAssignments || contractor.projectAssignments.length === 0 ? (
                <div className="p-8 text-center text-gray-500">
                  No active projects
                </div>
              ) : (
